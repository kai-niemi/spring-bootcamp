...
import io.cockroachdb.bootcamp.outbox.event.PurchaseOrderEvent;
...
public class OutboxChangeFeedListener {
    ...
    @KafkaListener(id = "outbox-demo", topics = "orders-outbox", groupId = "bootcamp",
            properties = {"spring.json.value.default.type=io.cockroachdb.bootcamp.outbox.event.PurchaseOrderEvent"})
