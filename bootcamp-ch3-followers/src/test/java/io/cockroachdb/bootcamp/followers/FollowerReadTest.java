...
import io.cockroachdb.bootcamp.FollowersApplication;
...
@SpringBootTest(classes = {FollowersApplication.class})
public class FollowerReadTest extends AbstractIntegrationTest {
